...
from app.serializers.AdminCustomerApprovals_serializers import AdminCustomerApprovalListSerializer
from rest_framework.permissions import IsAuthenticated
from app.permissions import IsAdminUser  
from rest_framework_simplejwt.authentication import JWTAuthentication


class AdminCustomerApprovalListView(APIView):
    ...
    def get(self, request):
        ...
        with connection.cursor() as cursor:
                ...
                for indx, customer in enumerate(data, start=1):
                    ...
                    # Add action link
                    customer['action_link'] = reverse('Admin_customers_approval_detail', args=[customer['customer_id']])


                # Use the serializer with `data`
                serializer = AdminCustomerApprovalListSerializer(data, many=True)
