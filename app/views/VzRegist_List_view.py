...
from app.serializers.VzRegist_List_serializers import VetzoneListSerializer
from django.conf import settings
import os

class VetzoneListView(generics.ListAPIView):
    serializer_class = VetzoneListSerializer

    def get_queryset(self):
        return Vetzone.objects.filter(approval_status='F')

    def get_serializer_context(self):
        # This will pass the request context to the serializer, allowing for proper Sr. No. calculation
...
class RegistListVetzoneDetailView(generics.RetrieveAPIView):
