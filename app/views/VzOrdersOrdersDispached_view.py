...
from app.serializers.VzOrdersOrdersDispached_serializers import VzOrdersDispatchedSerializer

class VzOrdersDispatchedView(APIView):
    def get(self, request, *args, **kwargs):
        with connection.cursor() as cursor:
            ...
            cursor.execute('''
                ...
                WHERE 
                    p.status = 'Y' -- Change status to reflect dispatched orders
                GROUP BY 
        ...
        for idx, row in enumerate(result, start=1):
            ...
            serializer = VzOrdersDispatchedSerializer(vetzone_data)
