...
class CeoCustomerApprovalDetailSerializer(serializers.Serializer):
    ...
    hq = serializers.CharField(allow_null=True, allow_blank=True)
    division = serializers.CharField(allow_null=True, allow_blank=True)
    subDivision = serializers.CharField(allow_null=True, allow_blank=True)
    vsoname = serializers.CharField(allow_null=True, allow_blank=True)
    vsomob = serializers.CharField(allow_null=True, allow_blank=True)
    ...
    cnf = serializers.CharField(allow_null=True, allow_blank=True)
    update_customer = serializers.CharField(allow_null=True, allow_blank=True)
    credit_days = serializers.CharField(allow_null=True, allow_blank=True)  # New field
    credit_limit = serializers.CharField(allow_null=True, allow_blank=True)  # New field
    ...
    class Meta:
        fields = [
            ...
            'contact_person_email', 'supplier', 'cnf', 'update_customer','credit_days', 'credit_limit'
        ]