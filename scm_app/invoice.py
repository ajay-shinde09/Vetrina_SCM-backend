...
# from .cust_OrderInvoice_serializers import CustomerinvoicecustSerializer
...
# class CustomerCustinvoiceView(APIView):
...
#                     # Conditionally show SGST/CGST or IGST based on state_code
#                 # if customer_invoice_data.get('state_code') == '27':
#                 #     # Show SGST/CGST data
#                 #     customer_invoice_data['SGST_Amt'] = total_SGST_Amt
#                 #     customer_invoice_data['CGST_Amt'] = total_CGST_Amt
#                 #     customer_invoice_data['SGST_per'] = Decimal(product.get('sgst_rate', 0))
#                 #     customer_invoice_data['CGST_per'] = Decimal(product.get('cgst_rate', 0))
#                 #     customer_invoice_data['total_gst_cs'] = total_gst_cs
#                 #     customer_invoice_data['NET_AMT_cs'] = NET_AMT_cs
#                 # else:
#                 #     # Show IGST data
#                 #     customer_invoice_data['IGST_Amt'] = total_IGST_Amt
#                 #     customer_invoice_data['IGST_per'] = Decimal(product.get('igst_rate', 0))
#                 #     customer_invoice_data['total_gst_I'] = total_IGST_Amt
#                 #     customer_invoice_data['NET_AMT_i'] = NET_AMT_i
...
#             serializer = CustomerinvoicecustSerializer({
